...
<head>
    ...
    <link href="${staticDomain}/static/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="${staticDomain}/static/assets/global/plugins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="${staticDomain}/static/assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css">
    <link rel="stylesheet" href="${staticDomain}/static/assets/global/css/components.min.css">
    <link rel="stylesheet" href="${staticDomain}/static/assets/global/css/plugins.min.css">
    <link rel="stylesheet" href="${staticDomain}/static/assets/global/plugins/bootstrap-table/bootstrap-table.min.css">
    <link rel="stylesheet" href="${staticDomain}/static/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css">
</head>
<body>
...
<script src="${staticDomain}/static/assets/global/plugins/jquery.min.js"></script>
<script src="${staticDomain}/static/assets/global/plugins/bootstrap/js/bootstrap.min.js"></script>
<script src="${staticDomain}/static/assets/global/plugins/bootstrap-table/bootstrap-table.min.js"></script>
<script src="${staticDomain}/static/assets/global/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
<script src="${staticDomain}/static/assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js"></script>
<script src="${staticDomain}/static/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script src="${staticDomain}/static/main/tool.js"></script>
<script src="${staticDomain}/static/pool/ofuser.js"></script>
</body>
</html>