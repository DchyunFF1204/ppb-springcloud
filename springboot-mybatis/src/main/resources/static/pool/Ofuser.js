...
var ofuserJs = {
    ...
    $('#tb_departments').bootstrapTable({
        url: ofuserJs.getQueryTableLink(), //请求后台的URL（*）
        method: 'post', //请求方式（*）
                    ...
                    var ops = ofuserJs.setButtons([
                        {
                            ...
                            callFunction : 'ofuserJs.openAddOrEdieModal(this)'
                        },
                        {
                            type: 'del',
                            title:'删除',
                            ...
                            callFunction : 'ofuserJs.removeData(this)'
                        }
                    ]);
                    return ops;
                 }
    ...
    initButton : function () {
        ...
        $('.js-table-add').on('click', function () {
            ofuserJs.openAddOrEdieModal();
        });
    },
    // 获取查询链接
    getQueryTableLink :function () {
        return ofuserJs.queryTableLink+"?rn="+Math.random();
    },
    // 查询table data
