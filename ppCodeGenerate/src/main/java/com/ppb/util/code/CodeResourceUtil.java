...
{
  private static final ResourceBundle bundle = ResourceBundle.getBundle(CodeResourceUtil.class.getPackage().toString().substring(8)+".code");
  private static final ResourceBundle bundlePath = ResourceBundle.getBundle(CodeResourceUtil.class.getPackage().toString().substring(8)+".code");
  
  public static String MODEL_PACKAGE="";
  public static String DAO_PACKAGE="";
  public static String SERVICE_PACKAGE="";
  public static String XML_MAPPER_PACKAGE="";
  public static String TARGET_ENTITY_PROJECT="";
  public static String TARGET_SERVER_PROJECT="";
  public static String TARGET_SERVER_MAPPER_PROJECT="";
  public static String CONTROLLER_PACKAGE="";
  public static String FTL_PACKAGE="";
  ...
  static
  {
	FTL_PACKAGE=bundlePath.getString("ftl.package");
	MODEL_PACKAGE=bundlePath.getString("model.package");
	DAO_PACKAGE=bundlePath.getString("dao.package");
	SERVICE_PACKAGE=bundlePath.getString("service.package");
	CONTROLLER_PACKAGE = bundlePath.getString("controller.package");
	XML_MAPPER_PACKAGE=bundlePath.getString("xml.mapper.package");
	TARGET_ENTITY_PROJECT=bundlePath.getString("target.entity.project");
	TARGET_SERVER_PROJECT=bundlePath.getString("target.server.project");
	TARGET_SERVER_MAPPER_PROJECT=bundlePath.getString("target.server.mapper.project");
